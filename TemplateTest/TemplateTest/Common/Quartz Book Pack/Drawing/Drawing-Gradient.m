...
{
    NSAssert(colorsArray != nil, @"Missing colors array");
...
//    if (!locationArray) COMPLAIN_AND_BAIL_NIL(@"Missing location array", nil);
    NSAssert(locationArray != nil, @"Missing location array");
...
//    if (context == NULL) COMPLAIN_AND_BAIL(@"No context to draw into", nil);
    NSAssert(context != NULL, @"No context to draw into");
...
{
    if (!block)
        NSAssert(block != nil, @"Must pass interpolation block");
