...
- (instancetype)initWithFrameOrigin:(CGPoint)origin width:(CGFloat)width {
    ...
    CGFloat monthHeight = 240;
    
    // 星期头部栏高度
    CGFloat weekHeaderHeight = 40;
    
    // calendar 头部栏高度
    CGFloat calendarHeaderHeight = 0;
    ...
    if (self = [super initWithFrame:CGRectMake(origin.x, origin.y, width, _calendarHeight)]) {
        ...
        self.layer.borderColor = kGFCalendarScrollViewLineColor.CGColor;
        self.layer.borderWidth = kGFCalendarScrollViewLineWidth;
        self.layer.masksToBounds = YES;
        self.layer.cornerRadius = 3;
        
        _weekHeaderView = [self setupWeekHeadViewWithFrame:CGRectMake(0, calendarHeaderHeight, width, weekHeaderHeight)];
        _calendarScrollView = [self setupCalendarScrollViewWithFrame:CGRectMake(0, calendarHeaderHeight + weekHeaderHeight, width, monthHeight)];
