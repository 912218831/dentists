...
- (void)setupCollectionViews {
    ...
    UIView *contentViewL = [[UIView alloc]initWithFrame:CGRectMake(0.0, 0.0, selfWidth, selfHeight)];
    _collectionViewL = [[UICollectionView alloc] initWithFrame:CGRectMake(offsetX, 0, contentViewL.width-2*offsetX, contentViewL.height) collectionViewLayout:flowLayout];
    ...
    [self addSubview:contentViewL];
    [contentViewL addSubview:_collectionViewL];
    
    UIView *contentViewM = [[UIView alloc]initWithFrame:CGRectMake(selfWidth, 0.0, selfWidth, selfHeight)];
    _collectionViewM = [[UICollectionView alloc] initWithFrame:CGRectMake(offsetX, 0, contentViewM.width-2*offsetX, contentViewM.height) collectionViewLayout:flowLayout];
    ...
    [self addSubview:contentViewM];
    [contentViewM addSubview:_collectionViewM];
    
    UIView *contentViewR = [[UIView alloc]initWithFrame:CGRectMake(2 * selfWidth, 0.0, selfWidth, selfHeight)];
    _collectionViewR = [[UICollectionView alloc] initWithFrame:CGRectMake(offsetX, 0, contentViewR.width-2*offsetX, contentViewR.height) collectionViewLayout:flowLayout];
    ...
    [self addSubview:contentViewR];
    [contentViewR addSubview:_collectionViewR];
    
    for (int i=0; i<6; i++) {
        UIView *lineL = [UIView new];
        UIView *lineM = [UIView new];
        UIView *lineR = [UIView new];
        [contentViewL addSubview:lineL];
        [contentViewM addSubview:lineM];
        [contentViewR addSubview:lineR];
        lineL.frame = CGRectMake(0, i*(selfHeight/6), selfWidth, kGFCalendarScrollViewLineWidth);
        lineL.backgroundColor = kGFCalendarScrollViewLineColor;
        lineM.frame = CGRectMake(0, i*(selfHeight/6), selfWidth, kGFCalendarScrollViewLineWidth);
        lineM.backgroundColor = kGFCalendarScrollViewLineColor;
        lineR.frame = CGRectMake(0, i*(selfHeight/6), selfWidth, kGFCalendarScrollViewLineWidth);
        lineR.backgroundColor = kGFCalendarScrollViewLineColor;
    }
}
